                ...
                <div className="pt-1">
                  {isCompleted ? (
                    ...
                    <button
                      ...
                      className="w-full py-3 rounded-2xl bg-[#004d2e] hover:bg-[#003822] text-white font-extrabold text-xs sm:text-sm flex items-center justify-center gap-2 shadow-md hover:shadow-lg transition-all active:scale-[0.99]"
                    >
